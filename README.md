...
이를 통해 기존 동기 방식대비 크롤링 속도를 **약 4.25배 향상**했습니다.(85초 → 20초)
...
### 1. 경기 일정 크롤링
KBO 사이트로부터 데이터를 수집하여 DB에 저장합니다. 이미 저장된 경기 정보라면 새로 수집된 정보로 업데이트합니다. 성공 시 수집된 건수, 저장된 건수, 수정된 건수를 반환합니다.
...
### 3. 단일 경기 조회
경기 고유 키를 이용하여 단일 경기의 정보를 조회합니다.
